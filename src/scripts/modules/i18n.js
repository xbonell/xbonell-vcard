...
const TRANSLATIONS = {
  [SUPPORTED_LANGUAGES.EN]: {
    ...
    'theme.toggle.aria.title': 'Current theme: "{currentTheme}". Click to cycle themes.',
  },
  ...
  [SUPPORTED_LANGUAGES.ES]: {
    ...
    'theme.toggle.aria.title': 'Tema actual: "{currentTheme}". Haz clic para cambiar de tema.',
  },
  ...
  [SUPPORTED_LANGUAGES.CA]: {
    ...
    'theme.system': 'Sistema',
    'theme.toggle': 'Alternar tema (Ctrl+Alt/Cmd+T)',
    'theme.toggle.aria.title': 'Tema actual: "{currentTheme}". Clica per canviar de tema.',
  },
};
