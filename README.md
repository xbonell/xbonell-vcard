...
- **Version 1.10.5**: Simplified browserslist configuration - increased market share threshold to > 2%, removed redundant rules, maintained excellent browser support while reducing build complexity
